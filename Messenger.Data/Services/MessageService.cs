        ...
        public MessageRepository()
        {
            ...
            using (var connection = new NpgsqlConnection(this.connectionString))
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    command.CommandText = "CREATE TABLE messages (id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Text varchar(128) NOT NULL, CreatedAt timestamp, Number int);";

                    command.ExecuteNonQuery();

                    command.CommandText = "GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO messages;";
